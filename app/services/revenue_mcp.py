...
VOICE_COMMAND_KEYWORDS: tuple[tuple[str, tuple[str, ...]], ...] = (
    ("收益分析", ("收益分析", "发收益分析", "做收益分析", "来个收益分析", "来一个收益分析", "给我收益分析", "帮我做收益分析")),
    ("昨日复盘", ("昨日复盘", "昨天复盘", "发昨日复盘", "发昨天复盘", "来个昨日复盘", "来一个昨日复盘", "给我昨日复盘")),
    ("调价方案", ("调价方案", "生成调价方案", "来个调价方案", "来一个调价方案", "来一个调教方案", "给我调价方案", "出一版调价方案")),
)
